      ...
      <section className="bg-ORANGE">
        <div className="max-w-lg bg-ORANGE px-4 pt-24 py-8 mx-auto text-left md:max-w-none md:text-center">
          <h1 className="text-3xl font-extrabold leading-10 tracking-tight  text-white text-center sm:leading-none md:text-6xl text-4xl lg:text-7xl">
            <span className="inline text-black  md:block">Made By</span>
            <span className=" mt-2 bg-clip-text  bg-gradient-to-r text-RED md:inline-block">
              {" "}
              Jaison
        ...
        <div className="max-w-screen-xl px-4 pt-8 mx-auto sm:px-6 lg:px-8">
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex justify-center mt-8 space-x-6">
              <a
                href="https://www.instagram.com/dz_jaison/"
